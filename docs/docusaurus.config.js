...
const config = createConfig({
  title: 'OpenZaak',
  tagline: 'Nextcloud ExApp packaging for the VNG OpenZaak case-management standard. Sidecar Python service, ZGW APIs, integrated with OpenRegister.',
  url: 'https://openzaak.conduction.nl',
  baseUrl: '/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://codeberg.org/Conduction/openzaak/src/branch/main/docs/',
        },
        blog: false,
        theme: {
  ...
  navbar: {
    items: [
      ...
      {
        href: 'https://codeberg.org/Conduction/openzaak',
        label: 'Codeberg',
        position: 'right',
      },
